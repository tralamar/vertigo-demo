 ...
 */
@DtDefinition
public final class Commande implements DtObject {
	 ...
	 */
	@Field(domain = "DO_IDENTIFIANT", type = "PRIMARY_KEY", notNull = true, label = "COM ID")
	 ...
	 */
	@Field(domain = "DO_CODE", notNull = true, label = "CODE")
	 ...
	 */
	@Field(domain = "DO_DATE", notNull = true, label = "DATE CREATION")
	 ...
	 */
	@Field(domain = "DO_IDENTIFIANT", type = "FOREIGN_KEY", notNull = true, label = "Client")
...
//		return this.<io.vertigo.demo.domain.commande.LigneCommande> getList(getLigneCommandeListURI());
		...
		final io.vertigo.dynamo.domain.metamodel.association.DtListURIForAssociation fkDtListURI = getLigneCommandeDtListURI();
		io.vertigo.lang.Assertion.checkNotNull(fkDtListURI);
		//---------------------------------------------------------------------
		//On est toujours dans un mode lazy.
		if (ligneCommande == null) {
			ligneCommande = io.vertigo.core.Home.getComponentSpace().resolve(io.vertigo.dynamo.persistence.PersistenceManager.class).getBroker().getList(fkDtListURI);
		}
	...
	public io.vertigo.dynamo.domain.metamodel.association.DtListURIForAssociation getLigneCommandeDtListURI() {
		return io.vertigo.dynamo.domain.util.DtObjectUtil.createDtListURI(this, "A_LCO_CMD", "LigneCommande");
	}
