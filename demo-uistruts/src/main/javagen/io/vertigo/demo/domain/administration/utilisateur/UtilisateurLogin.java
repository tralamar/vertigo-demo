...
public final class UtilisateurLogin implements DtObject {
	 ...
	 */
	@Field(domain = "DO_LOGIN", notNull = true, persistent = false, label = "Identifiant utilisateur")
	 ...
	 */
	@Field(domain = "DO_PASSWORD", notNull = true, persistent = false, label = "Mot de passe")
	 ...
	 */
	@Field(domain = "DO_PASSWORD", notNull = true, persistent = false, label = "Nouveau mot de passe")
	 ...
	 */
	@Field(domain = "DO_PASSWORD", notNull = true, persistent = false, label = "Resaisir le mot de passe")
