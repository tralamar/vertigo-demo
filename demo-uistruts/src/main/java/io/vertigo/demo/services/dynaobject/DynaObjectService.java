...
public interface DynaObjectService {
	 ...
	 * @return dtObject 
	 */
	DtObject load(final DtDefinition dtDefinition, final Serializable id);
	 ...
	 */
	DtList<? extends DtObject> getList(final DtDefinition dtDefinition);
	 ...
	 */
	void save(final DtObject dtObject);
