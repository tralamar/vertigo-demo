 ...
 */
public final class TutoMasterDataStoreStatic extends AbstractStaticDataStorePlugin {
	...
	public TutoMasterDataStoreStatic(final String prefix) {
		this.prefix = prefix;
	}
	...
	public TutoObjectType getTutoObjectEtatMDObject(final Long typId) {
		...
		tutoObjectType.setLibelle(prefix + "(+):Type" + typId);
	...
	public DtList<TutoObjectType> getTutoObjectTypeMDList() {
		...
		for (int i = 0; i < 12; i++) {
			...
			tutoObjectType.setCode(code);
			tutoObjectType.setLibelle(prefix + ":Type" + seq);
	...
	public DtList<TutoObjectEtat> getTutoObjectEtatMDList() {
		...
		for (int seq = 0; seq < 12; seq++) {
			...
			tutoObjectEtat.setLibelle(prefix + ":Etat" + seq);
